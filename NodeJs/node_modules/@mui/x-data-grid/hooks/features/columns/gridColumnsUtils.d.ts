...
import { GridColumnsState, GridColumnsRawState, GridColumnVisibilityModel, GridColumnsInitialState } from '@mui/x-data-grid/hooks/features/columns/gridColumnsInterfaces';
import { GridColType, GridColumnTypesRecord } from '@mui/x-data-grid/models';
import { GridStateCommunity } from '@mui/x-data-grid/models/gridStateCommunity';
import { GridApiCommunity } from '@mui/x-data-grid/models/api/gridApiCommunity';
import { GridColDef } from '@mui/x-data-grid/models/colDef/gridColDef';
import { GridApiCommon } from '@mui/x-data-grid/models/api/gridApiCommon';
import { GridRowEntry } from '@mui/x-data-grid/models/gridRows';
 ...
 */
export declare const getGridColDef: (columnTypes: GridColumnTypesRecord, type: GridColType | undefined) => import("@mui/x-data-grid/models").GridColTypeDef<any, any>;
