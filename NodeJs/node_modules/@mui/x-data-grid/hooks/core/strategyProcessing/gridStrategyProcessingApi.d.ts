import { GridRowTreeCreationParams, GridRowTreeCreationValue } from '@mui/x-data-grid/hooks/features/rows/gridRowsState';
import { GridFilteringMethodParams, GridFilteringMethodValue } from '@mui/x-data-grid/hooks/features/filter/gridFilterState';
import { GridSortingMethodParams, GridSortingMethodValue } from '@mui/x-data-grid/hooks/features/sorting/gridSortingState';
export declare type GridStrategyProcessorName = keyof GridStrategyProcessingLookup;
export declare type GridStrategyGroup = GridStrategyProcessingLookup[keyof GridStrategyProcessingLookup]['group'];
...
export declare type GridStrategyProcessor<P extends GridStrategyProcessorName> = (params: GridStrategyProcessingLookup[P]['params']) => GridStrategyProcessingLookup[P]['value'];
export interface GridStrategyProcessingApi {
     ...
     */
    unstable_registerStrategyProcessor: <P extends GridStrategyProcessorName>(strategyName: string, processorName: P, callback: GridStrategyProcessor<P>) => () => void;
    /**
     ...
     * @ignore - do not document.
     */
    unstable_setStrategyAvailability: (strategyGroup: GridStrategyGroup, strategyName: string, callback: () => boolean) => void;
    /**
     ...
     * @ignore - do not document.
     */
    unstable_applyStrategyProcessor: <P extends GridStrategyProcessorName>(processorName: P, params: GridStrategyProcessingLookup[P]['params']) => GridStrategyProcessingLookup[P]['value'];
}
